...
const Card = ({ data }) => {
  ...
  return (
    <div className="flex bg-[#1e1e1e] rounded-xl  pt-8 pb-4 w-[20rem] flex-col shadow-[0px_-2px_10px_rgba(0,0,0,0.2)]">
      ...
      <ul className="flex flex-col justify-center px-8 gap-3 w-full text-start">
        {service?.map((items, index) => {
          return (
            <li className="hover:bg-[#272626] cursor-pointer flex justify-between rounded-xl px-4 py-2" key={index}>
